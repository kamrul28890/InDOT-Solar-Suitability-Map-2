...
export function EditStep({ layers, onCellChange }) {
  // The table edits normalized in-memory GeoJSON and pages records to keep large
  // engineering datasets responsive.
  ...
  const records = useMemo(() => {
    // Search all visible properties using a serialized, case-insensitive view.
  ...
  const pageSize = 25;
  // Slice after filtering so pagination counts match the visible result set.
