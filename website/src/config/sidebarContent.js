// Curated project copy for the public sidebar. Live counts and layer metadata
// remain manifest-driven rather than being duplicated here.
export const sidebarContent = {
  ...
  projectInfo: {
    ...
    stakeholders: [
      ...
      {
        label: 'Academic home',
        value: 'Bowen School of Construction',
      },
    ],
    links: [
      {
