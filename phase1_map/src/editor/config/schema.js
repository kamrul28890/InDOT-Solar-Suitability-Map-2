// Fixed INDOT schema for the v1 editor. The browser editor accepts only the
...
// Mirrors phase2_editor/editor_backend/config.py and
// phase1_map/config/field_mapping.json so the exported package matches what the
// existing pipeline (scripts/export_app_data.py) produces.
...
// Canonical order — the manifest and map layering follow this sequence.
